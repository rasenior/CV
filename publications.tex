...
\hfill
\par
I have \textbf{14 publications} in international peer-reviewed journals, including \textbf{5 first author} articles. My \textbf{h-index = 10, i10-index = 10}, and \textbf{total citations = 2226} (as per \href{https://scholar.google.com/citations?hl=en&user=6-7FYjIAAAAJ&authuser=2}{Google Scholar Citations}).
