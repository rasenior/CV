...
\hfill
\par
I have \textbf{20 publications} in international peer-reviewed journals, including \textbf{7 first author} articles. My \textbf{h-index = 15, i10-index = 17}, and \textbf{total citations = 4887} (as per \href{https://scholar.google.com/citations?hl=en&user=6-7FYjIAAAAJ&authuser=2}{Google Scholar Citations}).
