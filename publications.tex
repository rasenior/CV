...
\hfill
\par
I have \textbf{25 publications} in international peer-reviewed journals, including \textbf{8 first author} articles. My \textbf{h-index = 18, i10-index = 21}, and \textbf{total citations = 6,162} (as per \href{https://scholar.google.com/citations?hl=en&user=6-7FYjIAAAAJ&authuser=2}{Google Scholar Citations}).
