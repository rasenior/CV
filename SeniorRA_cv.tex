...
\leftheader{%
  {\LARGE\bfseries\sffamily Rebecca A. Senior}
    ...
    \makefield{\faPhone}{\texttt{+447800881430}}
    \makefield{\faEnvelopeO}{\texttt{rebecca.a.senior@gmail.com}}
    \par
    \makefield{\faGlobe}{\href{https://rasenior.rbind.io/}{\nolinkurl{rasenior.rbind.io}}}
    \makefield{\faLinkedinSquare}{\href{http://www.linkedin.com/in/rebecca-senior}{\nolinkurl{rebecca-senior}}}
    %\makefield{\faSkype}{\texttt{senior.rebecca}}
    \makefield{\faGithub}{\href{https://github.com/rasenior}{\nolinkurl{rasenior}}}
}
