...
\entry*[Field skills\hfill] Extensive knowledge of history of British countryside $\diamond$ Competent ID of several taxa: \textbf{fungi, vascular plants, mammals, birds} $\diamond$ Experienced in forestry techniques $\diamond$ User and developer of modern technologies for monitoring, including \textbf{satellite imagery, drones, microclimate dataloggers, camera traps, acoustic recorders, thermal imaging}.
